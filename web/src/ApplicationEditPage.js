    ...
    return (
      <Card size="small" title={
        ...
        <Row style={{marginTop: "20px"}} >
          ...
          <Col span={22} >
            <Select virtual={false} style={{width: "100%"}} disabled={!Setting.isLocalAdminUser(this.props.account)} value={this.state.application.organization} onChange={(value => {this.updateApplicationField("organization", value);})}>
              {
