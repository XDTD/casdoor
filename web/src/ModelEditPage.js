    ...
    return (
      <Card size="small" title={
        ...
        <Row style={{marginTop: "10px"}} >
          ...
          <Col span={22} >
            <Select virtual={false} style={{width: "100%"}} disabled={!Setting.isLocalAdminUser(this.props.account)} value={this.state.model.owner} onChange={(value => {this.updateModelField("owner", value);})}>
              {
